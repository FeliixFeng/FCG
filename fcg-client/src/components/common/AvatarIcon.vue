<script setup>
/**
 * AvatarIcon — 根据 relation / role 渲染头像
 * 优先级：用户真实 avatar URL > 本地预设图片 > SVG 兜底
 */
...
// ── 关键词 → 配置表 ──────────────────────────────────────
const RELATION_MAP = [
  { keys: ['爷爷', '外公', '祖父', '姥爷'], type: 'elder-male',      color: '#4a6fa5', bg: '#e8eef6', img: '/avatars/grandpa.png' },
  { keys: ['奶奶', '外婆', '祖母', '姥姥'], type: 'elder-female',    color: '#7c5cbf', bg: '#efe9f8', img: '/avatars/grandma.png' },
  { keys: ['爸爸', '父亲', '爸',  '父'],   type: 'adult-male',      color: '#2d5f5d', bg: '#e4f0ef', img: '/avatars/father.png' },
  { keys: ['妈妈', '母亲', '妈',  '母'],   type: 'adult-female',    color: '#c45c7a', bg: '#f7e8ee', img: '/avatars/mother.png' },
  { keys: ['儿子', '哥哥'],                 type: 'child-male-elder', color: '#e07b39', bg: '#faeee4', img: '/avatars/elderbrother.png' },
  { keys: ['弟弟'],                         type: 'child-male-young', color: '#e07b39', bg: '#faeee4', img: '/avatars/youngerbrother.png' },
  { keys: ['女儿', '姐姐'],                 type: 'child-female-elder',color: '#c47a3a', bg: '#f7eddf', img: '/avatars/eldersister.png' },
  { keys: ['妹妹'],                         type: 'child-female-young',color: '#c47a3a', bg: '#f7eddf', img: '/avatars/youngersister.png' },
  { keys: ['孩子', '小孩', '宝宝'],        type: 'child-male-elder', color: '#e07b39', bg: '#faeee4', img: '/avatars/elderbrother.png' },
  { keys: ['自己', '本人', '我'],           type: 'adult-male',      color: '#3a7abf', bg: '#e5eff8', img: '/avatars/father.png' },
]

const ROLE_FALLBACK = {
  0: { type: 'admin',       color: '#2d5f5d', bg: '#e4f0ef', img: '/avatars/father.png' },   // 管理员
  1: { type: 'member',      color: '#5f7d8a', bg: '#e9eff2', img: '/avatars/elderbrother.png' }, // 普通成员
  2: { type: 'elder-male',  color: '#d4785a', bg: '#f7ece6', img: '/avatars/grandpa.png' },   // 关怀成员
}
...
<template>
  ...
  <div
    ...
    :style="{ width: size + 'px', height: size + 'px' }"
  >
    <img :src="cfg.img" :alt="nickname" class="avatar-img" />
  </div>
