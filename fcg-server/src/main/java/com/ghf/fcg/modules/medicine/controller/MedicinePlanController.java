...
public class MedicinePlanController {
    ...
    private final IMedicinePlanTaskService medicinePlanTaskService;
    ...
    public Result<PageResult<MedicinePlanRecordVO>> listPlanRecords(
        ...
        if (scheduledDate != null) {
            return Result.success(medicinePlanTaskService.buildDailyTasks(targetUserId, scheduledDate, status, query));
        }
