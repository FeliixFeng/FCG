...
public class HealthReportController {
    ...
    private final IHealthReportAnalysisService healthReportAnalysisService;
    ...
    public Result<HealthReportVO> generate(@RequestParam(required = false) Long userId) {
        ...
        String vitalData = healthReportAnalysisService.formatVitalData(vitals);
        ...
        try {
            ...
            return Result.error(healthReportAnalysisService.resolveAiErrorMessage(e));
        }
        ...
        int riskLevel = healthReportAnalysisService.analyzeRiskLevel(vitals, complianceRate);
