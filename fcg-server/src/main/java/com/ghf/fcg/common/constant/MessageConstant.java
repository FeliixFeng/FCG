...
public class MessageConstant {
    ...
    public static final String USER_NOT_IN_FAMILY = "用户未加入家庭";
    public static final String USER_ALREADY_IN_FAMILY = "用户已加入家庭";
    public static final String USER_ALREADY_IN_FAMILY_CREATE = "用户已加入家庭，无法创建";
    ...
    public static final String USER_FAMILY_MISMATCH = "用户不存在或不属于当前家庭";
